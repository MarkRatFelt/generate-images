...
def train(path, batch_size, EPOCHS):
    ...
    for epoch in range(EPOCHS):
        ...
        for index, image_batch in enumerate(BATCHES):
            ...
            print("Initial batch losses : ", "Generator loss", g_loss, "Discriminator loss", d_loss, "Total:",
                  g_loss + d_loss)
            ...
            print("Final batch losses (after updates) : ", "Generator loss", g_loss, "Discriminator loss", d_loss,
                  "Total:", g_loss + d_loss)
            print()
            if index % 20 == 0:
